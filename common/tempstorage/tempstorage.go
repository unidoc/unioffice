...
package tempstorage ;import _e "io";type storage interface{Open (_d string )(File ,error );TempFile (_c ,_g string )(File ,error );TempDir (_cc string )(string ,error );RemoveAll (_df string )error ;Add (_b string )error ;};
