...
func NewCT_pivotTableDefinition() *CT_pivotTableDefinition {
	...
	ret.DataOnRowsAttr = gooxml.Bool(false)
	ret.ShowErrorAttr = gooxml.Bool(false)
	ret.ShowMissingAttr = gooxml.Bool(true)
	ret.UpdatedVersionAttr = gooxml.Uint8(0)
	ret.MinRefreshableVersionAttr = gooxml.Uint8(0)
	ret.AsteriskTotalsAttr = gooxml.Bool(false)
	ret.ShowItemsAttr = gooxml.Bool(true)
	ret.EditDataAttr = gooxml.Bool(false)
	ret.DisableFieldListAttr = gooxml.Bool(false)
	ret.ShowCalcMbrsAttr = gooxml.Bool(true)
	ret.VisualTotalsAttr = gooxml.Bool(true)
	ret.ShowMultipleLabelAttr = gooxml.Bool(true)
	ret.ShowDataDropDownAttr = gooxml.Bool(true)
	ret.ShowDrillAttr = gooxml.Bool(true)
	ret.PrintDrillAttr = gooxml.Bool(false)
	ret.ShowMemberPropertyTipsAttr = gooxml.Bool(true)
	ret.ShowDataTipsAttr = gooxml.Bool(true)
	ret.EnableWizardAttr = gooxml.Bool(true)
	ret.EnableDrillAttr = gooxml.Bool(true)
	ret.EnableFieldPropertiesAttr = gooxml.Bool(true)
	ret.PreserveFormattingAttr = gooxml.Bool(true)
	ret.UseAutoFormattingAttr = gooxml.Bool(false)
	ret.PageWrapAttr = gooxml.Uint32(0)
	ret.PageOverThenDownAttr = gooxml.Bool(false)
	ret.SubtotalHiddenItemsAttr = gooxml.Bool(false)
	ret.RowGrandTotalsAttr = gooxml.Bool(true)
	ret.ColGrandTotalsAttr = gooxml.Bool(true)
	ret.FieldPrintTitlesAttr = gooxml.Bool(false)
	ret.ItemPrintTitlesAttr = gooxml.Bool(false)
	ret.MergeItemAttr = gooxml.Bool(false)
	ret.ShowDropZonesAttr = gooxml.Bool(true)
	ret.CreatedVersionAttr = gooxml.Uint8(0)
	ret.IndentAttr = gooxml.Uint32(1)
	ret.ShowEmptyRowAttr = gooxml.Bool(false)
	ret.ShowEmptyColAttr = gooxml.Bool(false)
	ret.ShowHeadersAttr = gooxml.Bool(true)
	ret.CompactAttr = gooxml.Bool(true)
	ret.OutlineAttr = gooxml.Bool(false)
	ret.OutlineDataAttr = gooxml.Bool(false)
	ret.CompactDataAttr = gooxml.Bool(true)
	ret.PublishedAttr = gooxml.Bool(false)
	ret.GridDropZonesAttr = gooxml.Bool(false)
	ret.ImmersiveAttr = gooxml.Bool(true)
	ret.MultipleFieldFiltersAttr = gooxml.Bool(true)
	ret.ChartFormatAttr = gooxml.Uint32(0)
	ret.FieldListSortAscendingAttr = gooxml.Bool(false)
	ret.MdxSubqueriesAttr = gooxml.Bool(false)
	ret.CustomListSortAttr = gooxml.Bool(true)
...
func (m *CT_pivotTableDefinition) UnmarshalXML(d *xml.Decoder, start xml.StartElement) error {
	...
	m.DataOnRowsAttr = gooxml.Bool(false)
	m.ShowErrorAttr = gooxml.Bool(false)
	m.ShowMissingAttr = gooxml.Bool(true)
	m.UpdatedVersionAttr = gooxml.Uint8(0)
	m.MinRefreshableVersionAttr = gooxml.Uint8(0)
	m.AsteriskTotalsAttr = gooxml.Bool(false)
	m.ShowItemsAttr = gooxml.Bool(true)
	m.EditDataAttr = gooxml.Bool(false)
	m.DisableFieldListAttr = gooxml.Bool(false)
	m.ShowCalcMbrsAttr = gooxml.Bool(true)
	m.VisualTotalsAttr = gooxml.Bool(true)
	m.ShowMultipleLabelAttr = gooxml.Bool(true)
	m.ShowDataDropDownAttr = gooxml.Bool(true)
	m.ShowDrillAttr = gooxml.Bool(true)
	m.PrintDrillAttr = gooxml.Bool(false)
	m.ShowMemberPropertyTipsAttr = gooxml.Bool(true)
	m.ShowDataTipsAttr = gooxml.Bool(true)
	m.EnableWizardAttr = gooxml.Bool(true)
	m.EnableDrillAttr = gooxml.Bool(true)
	m.EnableFieldPropertiesAttr = gooxml.Bool(true)
	m.PreserveFormattingAttr = gooxml.Bool(true)
	m.UseAutoFormattingAttr = gooxml.Bool(false)
	m.PageWrapAttr = gooxml.Uint32(0)
	m.PageOverThenDownAttr = gooxml.Bool(false)
	m.SubtotalHiddenItemsAttr = gooxml.Bool(false)
	m.RowGrandTotalsAttr = gooxml.Bool(true)
	m.ColGrandTotalsAttr = gooxml.Bool(true)
	m.FieldPrintTitlesAttr = gooxml.Bool(false)
	m.ItemPrintTitlesAttr = gooxml.Bool(false)
	m.MergeItemAttr = gooxml.Bool(false)
	m.ShowDropZonesAttr = gooxml.Bool(true)
	m.CreatedVersionAttr = gooxml.Uint8(0)
	m.IndentAttr = gooxml.Uint32(1)
	m.ShowEmptyRowAttr = gooxml.Bool(false)
	m.ShowEmptyColAttr = gooxml.Bool(false)
	m.ShowHeadersAttr = gooxml.Bool(true)
	m.CompactAttr = gooxml.Bool(true)
	m.OutlineAttr = gooxml.Bool(false)
	m.OutlineDataAttr = gooxml.Bool(false)
	m.CompactDataAttr = gooxml.Bool(true)
	m.PublishedAttr = gooxml.Bool(false)
	m.GridDropZonesAttr = gooxml.Bool(false)
	m.ImmersiveAttr = gooxml.Bool(true)
	m.MultipleFieldFiltersAttr = gooxml.Bool(true)
	m.ChartFormatAttr = gooxml.Uint32(0)
	m.FieldListSortAscendingAttr = gooxml.Bool(false)
	m.MdxSubqueriesAttr = gooxml.Bool(false)
	m.CustomListSortAttr = gooxml.Bool(true)
